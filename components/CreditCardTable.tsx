...
import { Trash2, Search, Calendar, getCategoryIcon, X, Edit2, Check, ArrowUpCircle, ArrowDownCircle, AlertCircle, CreditCard } from './Icons';
...
export const CreditCardTable: React.FC<CreditCardTableProps> = ({ transactions, onDelete, onUpdate }) => {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
                ...
                <p className="text-xs text-gray-400">{filteredTransactions.length} lançamentos na fatura</p>
            </div>
          </div>
