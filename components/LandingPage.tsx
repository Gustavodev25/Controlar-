...
const AnimatedSection: React.FC<{
  ...
  const baseClasses = `transition-all duration-700 ease-out ${
    isVisible ? 'translate-y-0 translate-x-0 opacity-100' : animations[direction]
  }`;
...
const AIInteractiveDemo = () => {
  ...
  return (
    <div className="relative w-full max-w-[calc(100vw-2rem)] sm:max-w-lg lg:max-w-md mx-auto animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
      <div className="bg-[#363735] border border-[#3A3B39] rounded-2xl shadow-2xl overflow-hidden relative z-20 flex flex-col h-[420px] sm:h-[500px] lg:h-[540px] min-h-0">
        ...
        <div className="px-4 py-3 bg-[#363735] border-b border-[#3A3B39] flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-white font-semibold text-sm">Coinzinha</div>
        ...
        >
          <div className="flex gap-3">
            ...
            <div className="bg-[#363735] border border-[#3A3B39] rounded-2xl px-4 py-3 text-sm text-gray-100 max-w-[75%] sm:max-w-[85%] shadow-inner break-words">
              <BlurredStagger
                text="Olá! Sou seu assistente financeiro. Posso ajudar a lançar gastos ou analisar suas finanças. Como posso ajudar hoje?"
                className="leading-relaxed"
              />
              <span className="text-[11px] text-gray-500 mt-2 block text-right">16:33</span>
            </div>
          </div>

          {(text || phase !== 'typing') && (
            <div className="flex gap-3 flex-row-reverse">
              <div className="w-8 h-8 rounded-full bg-[#d97757]/10 flex items-center justify-center shrink-0 border border-[#d97757]/40 text-[#d97757] font-semibold">
                VC
              </div>
              <div className="bg-[#2d211c] border border-[#d97757]/60 rounded-2xl rounded-tr-none px-4 py-3 text-sm text-white max-w-[75%] sm:max-w-[90%] shadow-lg transition-all duration-200 break-words">
                {text}
          ...
          {phase === 'processing' && (
            <div className="flex gap-3 animate-fade-in">
              ...
              <div className="bg-[#363735] border border-[#3A3B39] rounded-2xl rounded-tl-none px-4 py-3 flex items-center gap-2 text-gray-300">
                <TextShimmer className="font-medium text-sm">Processando...</TextShimmer>
              </div>
            </div>
          )}
          ...
          {phase === 'result' && (
            <div className="flex gap-3 animate-fade-in">
              ...
              <div className="space-y-2 w-full max-w-full sm:max-w-[90%]">
                ...
                <div className="bg-[#2F302E] border border-[#3A3B39] rounded-xl p-4 shadow-lg relative overflow-hidden">
                  ...
                  <div className="flex justify-between items-start mb-3 pl-2">
                    <div>
                      <p className="text-[11px] text-gray-500 uppercase tracking-wider mb-0.5">Descrição</p>
                      <p className="text-white font-semibold">{currentExample.result.desc}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-[11px] text-gray-500 uppercase tracking-wider mb-0.5">Valor</p>
                      <p className={`${currentExample.result.isExpense ? 'text-[#d97757]' : 'text-green-400'} font-bold font-mono text-lg`}>
                        {currentExample.result.val}
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-2 pl-2">
                    <span className="px-2 py-1 bg-[#363735] rounded-md text-xs text-gray-300 flex items-center gap-1.5 border border-[#3A3B39]">
        ...
        <div className="px-4 py-3 bg-[#2F302E] border-t border-[#3A3B39]">
          <div className="flex items-center gap-3 bg-[#363735] border border-[#d97757]/40 rounded-xl px-4 py-3 text-sm text-gray-400 focus-within:border-[#d97757] transition-colors">
            <input
              ...
              className="bg-transparent flex-1 outline-none placeholder:text-gray-600 text-gray-200"
            />
            <button className="w-9 h-9 rounded-full bg-[#d97757] text-white flex items-center justify-center shadow-lg hover:scale-105 transition-transform" disabled>
              <Send size={14} />
            </button>
          </div>
        </div>
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
       ...
       {/* Pro */}
       <div className="bg-[#363735] border border-[#f17853] rounded-3xl p-6 lg:p-8 flex flex-col relative shadow-2xl shadow-[#f17853]/10 lg:transform lg:-translate-y-4">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
           ...
           <div className="flex items-center gap-4">
              {isWaitlistVariant ? (
                ...
                <>
                  <button onClick={onLogin} className="text-sm font-bold text-gray-300 hover:text-white hidden md:block">
                     Login
                  </button>
                  <button
                    onClick={onLogin}
         ...
         <div className="max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center relative z-10">
            ...
            <div className="text-center lg:text-left relative z-20 w-full">
                {isWaitlistVariant ? (
                  ...
                  <div className="inline-flex items-center gap-2 px-3 lg:px-4 py-2 rounded-full bg-[#f17853]/10 border border-[#f17853]/20 text-[#f17853] text-xs lg:text-sm font-bold mb-6 lg:mb-8 animate-fade-in-up">
                    <Sparkles size={14} />
