...
>(({ active, payload, className, indicator = "dot", hideLabel = false, hideIndicator = false, label, labelFormatter, config, nameKey, labelKey }, ref) => {
    ...
    const tooltipLabel = React.useMemo(() => {
        ...
        if (labelFormatter) {
            return (
                <div className={cn("font-medium", className)}>{labelFormatter(label, payload)}</div>
            )
        }
    ...
    }, [label, labelFormatter, payload, hideLabel, className, config, contextConfig, labelKey])
                ...
                {payload.map((item, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Simplified content handling for brevity in this agent implementation */}
...
function getPayloadConfigFromPayload(
    ...
    return configLabelKey in config
        ...
        : config[key] as ChartConfig[string]
}
