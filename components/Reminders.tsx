...
import { Bell, CalendarClock, Check, Trash2, AlertCircle, DollarSign, Tag, Calendar, getCategoryIcon, X, LayoutDashboard, Table2, FileText, Clock, Sparkles, Plus, Bot, ArrowRight } from './Icons';
        ...
        <div className="bg-gray-900 p-6 rounded-xl border border-gray-800 shadow-sm flex items-center justify-between relative overflow-hidden group">
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-bold text-gray-500 uppercase tracking-wide">Quantidade</span>
            </div>
            <h3 className="text-3xl font-bold text-[#faf9f5]">{reminders.length}</h3>
            <p className="text-sm text-gray-400">Lembretes Ativos</p>
          </div>
        ...
        <div className="bg-gray-900 p-6 rounded-xl border border-gray-800 shadow-sm flex items-center justify-between relative overflow-hidden group">
          <div className="relative z-10">
             <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-bold text-gray-500 uppercase tracking-wide">Valor Total</span>
            </div>
                            ...
                            <div className="p-5 space-y-4">
                               <div className="flex items-start justify-between">
                                  ...
                                  <div className="text-right">
                                     ...
                                     <p className="text-2xl font-bold text-white">R$ {parsedReminder.amount.toFixed(2)}</p>
                                  </div>
                               </div>
               ...
               {modalMode === 'manual' && (
                 <form onSubmit={handleManualSubmit} className="space-y-5 animate-fade-in">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-xs font-medium text-gray-400 mb-1.5">Vencimento</label>
                  ...
                  <div className="bg-gray-900/50 p-4 rounded-2xl border border-gray-800/50 space-y-3">
                    <label className="flex items-center justify-between cursor-pointer select-none group">
                        <div className="flex items-center gap-3">
                           ...
                           <div>
                               <span className="block text-sm font-medium text-gray-200 group-hover:text-white transition-colors">Pagamento Recorrente</span>
                               <span className="block text-[10px] text-gray-500">Repetir este lembrete automaticamente</span>
                           </div>
                        </div>
                        <input 
                          type="checkbox" 
