...
export const AuthModal: React.FC<AuthModalProps> = ({ 
  ...
  // Effect to reset/focus OTP when entering 2FA mode
  React.useEffect(() => {
  ...
  const handleVerify = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      // Error handling is usually done in parent, but we can set generic error here if needed
      // Parent toast usually handles it.
    } finally {
      setIsLoading(false);
    }
  };
          ...
          {isTwoFactorPending ? (
             ...
             <div className="space-y-8 animate-fade-in">
                ...
                <form onSubmit={handleVerify} className="space-y-6">
                   ...
                   {error && (
                      <div className="p-3 rounded-lg bg-red-900/20 border border-red-900/50 text-red-400 text-xs flex items-center gap-2 justify-center">
                  ...
                  {isLogin && !isResettingPassword && (
                    <div className="flex justify-end">
                      <button
                        ...
                        className="text-xs font-medium text-[#d97757] hover:text-[#e68e70] font-bold hover:underline transition-all"
                      >
                        Esqueceu a senha?
                      </button>
                    </div>
