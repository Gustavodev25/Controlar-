...
export const CoinzinhaGreeting: React.FC = () => {
    ...
    return (
        <div className="mb-2 relative inline-block animate-fade-in-up">
            <div className="bg-gray-800 border border-gray-700 text-gray-200 px-4 py-3 rounded-2xl text-sm font-medium shadow-xl relative z-10 max-w-[240px] mx-auto text-left">
            ...
            {/* Speech Bubble Tail */}
            <div className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-3 h-3 bg-gray-800 border-b border-r border-gray-700 transform rotate-45 z-0"></div>
        </div>
    );
};