...
export interface Reminder {
  ...
  // Campos para lembretes automáticos de fatura de cartão
  autoGenerated?: boolean;  // True se foi gerado automaticamente
  cardId?: string;          // ID do cartão (se for lembrete de fatura)
