...
26/01/2026	JAN	FACEBK *FGRBDE5JP2	Serviços digitais	R$ 100,00	Pago
...
lines.forEach(line => {
    ...
    // Assume all values in list are Debits (Expenses) unless explicitly Negative
    if (isNegative) {
        value = -value;
    }
...
console.log('Total Sum (as Table):', sum.toFixed(2));
