 ...
 * 
 * Uso: node scripts/migrate_c6_descriptions.js
 */
...
async function migrateC6Descriptions() {
    ...
    try {
        ...
        for (const userDoc of usersSnapshot.docs) {
            ...
            console.log(`   ✅ Atualizadas: ${userTransactionsUpdated} | Ignoradas: ${userTransactionsSkipped} | Sem paymentData: ${userNoPaymentData}`);
